...
class AudioProcessor(object):
  ...
  def maybe_download_and_extract_dataset(self, data_url, dest_directory):
    ...
    print ("Extracting to : " + dest_directory)
  ...
  def get_predicion_data(self, filenames, model_settings, sess):
    """Retrieve sample data for the prediction, with no transformations.

    Args:
      filenames: Sample file names to read.
      model_settings: Information about the current model being trained.

    Returns:
      List of sample data for the samples.
    """
    ...
    for i in range(sample_count):
        ...
        background_reshaped = np.zeros([desired_samples, 1])
        input_dict = {
            self.wav_filename_placeholder_: filenames[sample_index],
            self.time_shift_padding_placeholder_: time_shift_padding,
            self.time_shift_offset_placeholder_: time_shift_offset,
